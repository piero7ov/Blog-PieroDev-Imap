...
if ($emails) {
    ...
    foreach ($emails as $email_number) {
        ...
        // ✅ FILTRO por ASUNTO (si hay búsqueda)
        if ($q !== '') {
            $subj = isset($overview->subject) ? imap_utf8($overview->subject) : '';
            if (stripos($subj, $q) === false) {
                continue;
            }
        }
...
// Helper para construir URLs con query
...
<head>
    ...
    <style>
        ...
        *{ box-sizing: border-box; }
        ...
        .post-content iframe,
        .post-content frame { display: none !important; }
        ...
        .post-content img[src^="CID:"] { display: none !important; }
...
<div class="wrap">
    ...
    <?php else: ?>
        ...
        <!-- ✅ BUSCADOR por asunto (solo portada) -->
